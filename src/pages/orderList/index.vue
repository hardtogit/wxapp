  ...
  <div class="container-box">
    <!-- <div class="classify-tab-menu">
      <div class="tab-item selected">
        <div class="tab-icon hx-icon"></div>
        <p class="tab-name">核销订单</p>
      </div>
      <div class="tab-item">
        <div class="tab-icon wm-icon"></div>
        <p class="tab-name">外卖订单</p>
      </div>
      <div class="tab-item">
        <div class="tab-icon wl-icon"></div>
        <p class="tab-name">物流订单</p>
      </div>
    </div> -->
    <div class="type-tab-menu">
      <div class="tab-item" :class="{'selected': selectedTab === 1}" @click="tabSwitch(1)">
        <p class="tab-name">待核销</p>
      </div>
      <div class="tab-item" :class="{'selected': selectedTab === 2}" @click="tabSwitch(2)">
        <p class="tab-name">已完成</p>
      </div>
      <div class="tab-item" :class="{'selected': selectedTab === 3}" @click="tabSwitch(3)">
        <p class="tab-name">其他</p>
      </div>
    </div>
...
export default {
  ...
  methods: {
    viewDetail (id) {
      const url = '../orderDetail/main?orderid=' + id + '&entryType=' + this.orderStatus
      wx.navigateTo({ url })
    },
    tabSwitch (num) {
