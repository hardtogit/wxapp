...
import * as echarts from './echarts.simple.min'
Component({
  properties: {
    canvasId: {
      type: String,
    ...
    init: function (callback) {
      ...
      query.select('.ec-canvas').boundingClientRect(res => {
        if (typeof callback === 'function') {
          ...
          this.chart = _this.initChart(canvas, res.width, res.height, ec)
        }
      }).exec()
    },
    initChart (canvas, width, height, ec) {
